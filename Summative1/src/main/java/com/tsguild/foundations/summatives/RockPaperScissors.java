 ...
 */
package com.tsguild.foundations.summatives;
...
public class RockPaperScissors {
    ...
    */
    public static int convertChoiceToInt(String userChoice) {
    ...
    */
    public static String convertIntToChoice(int choiceInt) {
        switch (choiceInt) {
            case 1:
                return "Rock";
            case 2:
    ...
    Outputs: None
    */
    public static void printChoices(int userInt, int compInt){
    ...
    */
    public static int determineWinner(int userIntChoice, int compIntChoice) {
    ...
    Outputs: None
    */
    public static void printStats(int userWins, int compWins, int ties) {
